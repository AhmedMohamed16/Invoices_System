        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="page-title-box">
                    <h4 class="page-title">تقارير العملاء</h4>
                </div>
                ...
                <form action="/Search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Bank" class="form-control select2" onclick="console.log($(this).val())"
                            ...
                            <div class="input-group" id="datepicker1">
                                ...
                                <input class="form-control"  
                                    name="start_at" placeholder="YYYY-MM-DD" type="text"
                                     value="{{ $start_at ?? '' }}"  data-provide="datepicker" data-date-container="#datepicker1"
                                    >
                            </div><!-- input-group -->
                        </div>
                            ...
                            <div class="input-group" id="datepicker1">
                                <input class="form-control"  
                                    name="end_at" placeholder="YYYY-MM-DD" type="text"
                                     value="{{ $end_at ?? '' }}"  data-provide="datepicker" data-date-container="#datepicker1"
                                    >
                            </div><!-- input-group -->
                        </div>
                    </div><br>
